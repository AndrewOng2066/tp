...
public class TypicalPersons {
    ...
    public static final Person ALICE = new PersonBuilder().withName("Alice Pauline")
            ...
            .withPhone("94351253")
            .withDate(new Attendance(new AttendanceStatus("03-02-2024", "1")), new Attendance(new AttendanceStatus("02-05-2024", "1"))).build();
    ...
    public static final Person IDA = new PersonBuilder().withName("Ida Mueller").withPhone("8482131")
            ...
            .withDate(new Attendance(new AttendanceStatus(VALID_DATE_1, "1")), new Attendance(new AttendanceStatus(VALID_DATE_2, "1"))).build();
    ...
    public static final Person BOB = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
            .withEmail(VALID_EMAIL_BOB).withStudentID(VALID_STUDENT_ID_BOB).withDate(new Attendance(new AttendanceStatus(VALID_DATE_1, "1")), new Attendance(new AttendanceStatus(VALID_DATE_2, "1")))
            .build();
